...
Then open in Expo Go, or press `i` / `a` / `w`.
...
Use [EAS Build](https://docs.expo.dev/build/introduction/) with the included `eas.json` profiles when you are ready to ship.
